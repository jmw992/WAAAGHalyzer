...
export const transformDbMatchToRecordedMatch = (
  ...
  return {
    ...
    player1Faction: dbMatch.player1_faction as Faction | null,
    player2Faction: dbMatch.player2_faction as Faction | null,
    win: dbMatch.win,
    map: dbMatch.map,
    ...
    notes: dbMatch.notes,
    version_major: dbMatch.version_major,
    version_minor: dbMatch.version_minor,
    version_patch: dbMatch.version_patch,
